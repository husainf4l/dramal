        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendedAge = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    AgeInDays = table.Column<int>(type: "integer", nullable: false),
                    ScheduleOrder = table.Column<int>(type: "integer", nullable: false),
                    VaccineInfo = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SideEffects = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Clinic = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
